...
class Dealer(Gamer):
    ...
    def first_card_value(self):  # 显示第一张牌
...
class Player(Gamer):
    ...
    def get_state(self, dealer):
        ...
        player_points, usable_ace = self.get_points()
        return dealer_first_card_value, player_points, usable_ace
...
arena.play_games(dealer, player, num=30000)
